...
import { View, Text, TextInput, TouchableOpacity, Modal, StyleSheet, Alert, FlatList, Image } from 'react-native';
...
type LandingScreenNavigationProp = StackNavigationProp<RootStackParamList, 'LandingScreen'>;
...
const LandingScreen: React.FC = () => {
  ...
  useEffect(() => {
    if (route.params?.newTransaction) {
      setTransactions(prev => [...prev, route.params.newTransaction]);
